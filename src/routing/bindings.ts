...
export function listBindings(cfg: KimibotConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: KimibotConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: KimibotConfig) {
