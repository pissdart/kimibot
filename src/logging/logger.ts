...
export const DEFAULT_LOG_DIR = "/tmp/kimibot";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "kimibot.log"); // legacy single-file path

const LOG_PREFIX = "kimibot";
...
function resolveSettings(): ResolvedSettings {
  let cfg: KimibotConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => KimibotConfig;
      };
