...
function resolveAnthropicDefaultAuthMode(cfg: KimibotConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: KimibotConfig): KimibotConfig {
...
export function applyTalkApiKey(config: KimibotConfig): KimibotConfig {
...
export function applyModelDefaults(cfg: KimibotConfig): KimibotConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: KimibotConfig): KimibotConfig {
...
export function applyLoggingDefaults(cfg: KimibotConfig): KimibotConfig {
...
export function applyContextPruningDefaults(cfg: KimibotConfig): KimibotConfig {
...
export function applyCompactionDefaults(cfg: KimibotConfig): KimibotConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) return cfg;
