...
export const A2UI_PATH = "/__kimibot__/a2ui";
export const CANVAS_HOST_PATH = "/__kimibot__/canvas";
export const CANVAS_WS_PATH = "/__kimibot/ws";
...
(() => {
  ...
  const handlerNames = ["kimibotCanvasA2UIAction", "${legacyHandlerName}"];
  ...
  globalThis.Kimibot = globalThis.Kimibot ?? {};
  globalThis.Kimibot.postMessage = postToNode;
  globalThis.Kimibot.sendUserAction = sendUserAction;
  globalThis.kimibotPostMessage = postToNode;
  globalThis.kimibotSendUserAction = sendUserAction;
  globalThis.kimibotPostMessage = postToNode;
  globalThis.kimibotSendUserAction = sendUserAction;
