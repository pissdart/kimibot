...
export function buildServiceEnvironment(params: {
  ...
  return {
    ...
    KIMIBOT_PROFILE: profile,
    KIMIBOT_STATE_DIR: env.KIMIBOT_STATE_DIR,
    KIMIBOT_CONFIG_PATH: env.KIMIBOT_CONFIG_PATH,
    KIMIBOT_GATEWAY_PORT: String(port),
    KIMIBOT_GATEWAY_TOKEN: token,
    KIMIBOT_LAUNCHD_LABEL: resolvedLaunchdLabel,
    KIMIBOT_SYSTEMD_UNIT: systemdUnit,
    KIMIBOT_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    KIMIBOT_SERVICE_KIND: GATEWAY_SERVICE_KIND,
    KIMIBOT_SERVICE_VERSION: VERSION,
  };
}
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    KIMIBOT_STATE_DIR: env.KIMIBOT_STATE_DIR,
    KIMIBOT_CONFIG_PATH: env.KIMIBOT_CONFIG_PATH,
    KIMIBOT_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    KIMIBOT_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    KIMIBOT_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    KIMIBOT_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    KIMIBOT_LOG_PREFIX: "node",
    KIMIBOT_SERVICE_MARKER: NODE_SERVICE_MARKER,
    KIMIBOT_SERVICE_KIND: NODE_SERVICE_KIND,
    KIMIBOT_SERVICE_VERSION: VERSION,
  };
}
