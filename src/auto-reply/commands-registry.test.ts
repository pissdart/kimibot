...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@kimibot", { botUsername: "kimibot" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@kimibot args", {
        botUsername: "kimibot",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "kimibot" })).toBe(
      "/help@otherbot",
    );
  });
