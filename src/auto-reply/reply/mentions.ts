...
function resolveMentionPatterns(cfg: KimibotConfig | undefined, agentId?: string): string[] {
  if (!cfg) return [];
...
export function buildMentionRegexes(cfg: KimibotConfig | undefined, agentId?: string): RegExp[] {
