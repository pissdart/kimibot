const DEFAULT_TAGLINE = "All your chats, one Kimibot.";
...
const TAGLINES: string[] = [
  "Your terminal just got brighter—type something and let the bot handle the busywork.",
  ...
  "Automation with vision: minimal fuss, maximal clarity.",
  ...
  "Moon rising, commit in—let's ship something mildly responsible.",
  "I'll light up your workflow like moonlight: clear, calm, effective.",
  "Shell yeah—I'm here to lighten the toil and leave you the glory.",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.KIMIBOT_TAGLINE_INDEX;
