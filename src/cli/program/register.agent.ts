...
${formatHelpExamples([
  ['kimibot agent --to +15555550123 --message "status update"', "Start a new session."],
  ['kimibot agent --agent ops --message "Summarize logs"', "Use a specific agent."],
  [
    'kimibot agent --session-id 1234 --message "Summarize inbox" --thinking medium',
    "Target a session with explicit thinking level.",
  ],
  [
    'kimibot agent --to +15555550123 --message "Trace logs" --verbose on --json',
    "Enable verbose logging and JSON output.",
  ],
  ['kimibot agent --to +15555550123 --message "Summon reply" --deliver', "Deliver reply."],
  [
    'kimibot agent --agent ops --message "Generate report" --deliver --reply-channel slack --reply-to "#reports"',
...
${theme.heading("Examples:")}
${formatHelpExamples([
  ['kimibot agents set-identity --agent main --name "Kimi" --emoji "🦞"', "Set name + emoji."],
  ["kimibot agents set-identity --agent main --avatar avatars/kimi.png", "Set avatar path."],
  ["kimibot agents set-identity --workspace ~/kimi --from-identity", "Load from IDENTITY.md."],
  [
    "kimibot agents set-identity --identity-file ~/kimi/IDENTITY.md --agent main",
