...
const SANDBOX_EXAMPLES = {
  main: [
    ["kimibot sandbox list", "List all sandbox containers."],
    ["kimibot sandbox list --browser", "List only browser containers."],
    ["kimibot sandbox recreate --all", "Recreate all containers."],
    ["kimibot sandbox recreate --session main", "Recreate a specific session."],
    ["kimibot sandbox recreate --agent mybot", "Recreate agent containers."],
    ["kimibot sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["kimibot sandbox list", "List all sandbox containers."],
    ["kimibot sandbox list --browser", "List only browser containers."],
    ["kimibot sandbox list --json", "JSON output."],
  ],
  recreate: [
    ["kimibot sandbox recreate --all", "Recreate all containers."],
    ["kimibot sandbox recreate --session main", "Recreate a specific session."],
    ["kimibot sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["kimibot sandbox recreate --browser --all", "Recreate only browser containers."],
    ["kimibot sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["kimibot sandbox explain", "Show effective sandbox config."],
    ["kimibot sandbox explain --session agent:main:main", "Explain a specific session."],
    ["kimibot sandbox explain --agent work", "Explain an agent sandbox."],
    ["kimibot sandbox explain --json", "JSON output."],
  ],
} as const;
