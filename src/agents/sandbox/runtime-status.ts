...
function resolveMainSessionKeyForSandbox(params: { cfg?: KimibotConfig; agentId: string }): string {
...
export function resolveSandboxRuntimeStatus(params: { cfg?: KimibotConfig; sessionKey?: string }): {
  agentId: string;
  sessionKey: string;
...
export function formatSandboxToolPolicyBlockedMessage(params: {
  ...
  lines.push(
    `- See: ${formatCliCommand(`kimibot sandbox explain --session ${runtime.sessionKey}`)}`,
  );
