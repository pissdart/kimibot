...
describe("createKimibotCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createKimibotCodingTools({
      config,
    ...
    const anthropicTools = createKimibotCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createKimibotCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createKimibotCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
