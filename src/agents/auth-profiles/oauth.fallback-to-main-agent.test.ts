...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveKimibotAgentDir() returns mainAgentDir
    process.env.KIMIBOT_STATE_DIR = tmpDir;
    process.env.KIMIBOT_AGENT_DIR = mainAgentDir;
