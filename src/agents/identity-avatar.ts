...
function resolveAvatarSource(cfg: KimibotConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: KimibotConfig, agentId: string): AgentAvatarResolution {
