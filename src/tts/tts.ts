...
export function resolveTtsConfig(cfg: KimibotConfig): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.KIMIBOT_TTS_PREFS?.trim();
...
export function buildTtsSystemPromptHint(cfg: KimibotConfig): string | undefined {
