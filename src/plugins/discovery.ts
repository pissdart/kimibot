...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @kimibot/voice-call -> voice-call).
...
function addCandidate(params: {
  ...
  params.candidates.push({
    ...
    packageKimibot: getPackageManifestMetadata(manifest ?? undefined),
  });
}
...
export function discoverKimibotPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExt = path.join(workspaceRoot, ".kimibot", "extensions");
    discoverInDirectory({
      dir: workspaceExt,
      origin: "workspace",
