...
export const PLUGIN_MANIFEST_FILENAME = "kimibot.plugin.json";
...
// package.json "kimibot" metadata (used for onboarding/catalog)
...
export type KimibotPackageManifest = {
  extensions?: string[];
...
): KimibotPackageManifest | undefined {
  if (!manifest) return undefined;
  return manifest.kimibot ?? manifest[LEGACY_MANIFEST_KEY];
}
