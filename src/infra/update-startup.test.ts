...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "kimibot-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveKimibotPackageRoot } = await import("./kimibot-root.js");
    ...
    vi.mocked(resolveKimibotPackageRoot).mockResolvedValue("/opt/kimibot");
