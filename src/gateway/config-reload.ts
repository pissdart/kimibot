...
import type { KimibotConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: KimibotConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: KimibotConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: KimibotConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: KimibotConfig) => void;
  log: {
