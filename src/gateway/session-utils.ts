...
import { type KimibotConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: KimibotConfig): string[] {
...
export function listAgentsForGateway(cfg: KimibotConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: KimibotConfig): string {
  return normalizeAgentId(resolveDefaultAgentId(cfg));
}

export function resolveSessionStoreKey(params: { cfg: KimibotConfig; sessionKey: string }): string {
...
function resolveSessionStoreAgentId(cfg: KimibotConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: KimibotConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: KimibotConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: KimibotConfig): GatewaySessionsDefaults {
