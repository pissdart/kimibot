...
export type ChannelAgentToolFactory = (params: { cfg?: KimibotConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: KimibotConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: KimibotConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: KimibotConfig }) => boolean;
  supportsCards?: (params: { cfg: KimibotConfig }) => boolean;
