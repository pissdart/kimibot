...
export function applyZaiConfig(cfg: KimibotConfig): KimibotConfig {
...
export function applyOpenrouterProviderConfig(cfg: KimibotConfig): KimibotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: KimibotConfig): KimibotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: KimibotConfig): KimibotConfig {
...
export function applyOpenrouterConfig(cfg: KimibotConfig): KimibotConfig {
...
export function applyMoonshotProviderConfig(cfg: KimibotConfig): KimibotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotConfig(cfg: KimibotConfig): KimibotConfig {
...
export function applyKimiCodeProviderConfig(cfg: KimibotConfig): KimibotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: KimibotConfig): KimibotConfig {
...
export function applySyntheticProviderConfig(cfg: KimibotConfig): KimibotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: KimibotConfig): KimibotConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: KimibotConfig): KimibotConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: KimibotConfig): KimibotConfig {
