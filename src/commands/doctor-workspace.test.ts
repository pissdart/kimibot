...
describe("detectLegacyWorkspaceDirs", () => {
  it("ignores ~/kimibot when it doesn't look like a workspace (e.g. install dir)", () => {
    const home = "/home/user";
    const workspaceDir = "/home/user/kimi";
    const candidate = path.join(home, "kimibot");
  ...
  it("flags ~/kimibot when it contains workspace markers", () => {
    const home = "/home/user";
    const workspaceDir = "/home/user/kimi";
    const candidate = path.join(home, "kimibot");
