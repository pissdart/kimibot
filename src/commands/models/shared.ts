...
export async function updateConfig(
  mutator: (cfg: KimibotConfig) => KimibotConfig,
...
export function resolveModelTarget(params: { raw: string; cfg: KimibotConfig }): {
  provider: string;
  model: string;
} {
...
export function buildAllowlistSet(cfg: KimibotConfig): Set<string> {
