...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "kimibot-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<KimibotConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<KimibotConfig["telegram"]>>,
