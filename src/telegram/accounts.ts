...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.KIMIBOT_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: KimibotConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: KimibotConfig): string {
...
function mergeTelegramAccountConfig(cfg: KimibotConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: KimibotConfig): ResolvedTelegramAccount[] {
