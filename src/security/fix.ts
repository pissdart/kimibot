...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof KimibotConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: KimibotConfig; env: NodeJS.ProcessEnv }): {
  cfg: KimibotConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
