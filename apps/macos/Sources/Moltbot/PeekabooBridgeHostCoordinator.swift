...
final class PeekabooBridgeHostCoordinator {
    ...
    private var services: KimibotPeekabooBridgeServices?
    ...
    private func startIfNeeded() async {
        ...
        let services = KimibotPeekabooBridgeServices()
        ...
        let host = PeekabooBridgeHost(
            socketPath: PeekabooBridgeConstants.kimibotSocketPath,
            server: server,
        ...
        await host.start()
        self.logger
            .info("PeekabooBridge host started at \(PeekabooBridgeConstants.kimibotSocketPath, privacy: .public)")
    }
...
@MainActor
private final class KimibotPeekabooBridgeServices: PeekabooBridgeServiceProviding {
