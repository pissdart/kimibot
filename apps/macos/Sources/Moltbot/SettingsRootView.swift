...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .kimibotSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? KimibotPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? KimibotPaths.stateDirURL.path
...
extension Notification.Name {
    static let kimibotSelectSettingsTab = Notification.Name("kimibotSelectSettingsTab")
}
