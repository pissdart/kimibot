...
enum UIStrings {
    static let welcomeTitle = "Welcome to Kimibot"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: KimibotOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: KimibotChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g kimibot@\(version)"
    }
