...
enum AnthropicAuthMode: Equatable {
    ...
    var shortLabel: String {
        switch self {
        case .oauthFile: "OAuth (Kimibot token file)"
...
enum AnthropicAuthResolver {
    static func resolve(
        ...
        oauthStatus: KimibotOAuthStore.AnthropicOAuthStatus = KimibotOAuthStore
...
enum KimibotOAuthStore {
    static let oauthFilename = "oauth.json"
    private static let providerKey = "anthropic"
    private static let kimibotOAuthDirEnv = "KIMIBOT_OAUTH_DIR"
    ...
    enum AnthropicOAuthStatus: Equatable {
        ...
        var shortDescription: String {
            switch self {
            case .missingFile: "Kimibot OAuth token file not found"
            case .unreadableFile: "Kimibot OAuth token file not readable"
            case .invalidJSON: "Kimibot OAuth token file invalid"
            case .missingProviderEntry: "No Anthropic entry in Kimibot OAuth token file"
            case .missingTokens: "Anthropic entry missing tokens"
            case .connected: "Kimibot OAuth credentials found"
            }
        }
    }

    static func oauthDir() -> URL {
        if let override = ProcessInfo.processInfo.environment[self.kimibotOAuthDirEnv]?
