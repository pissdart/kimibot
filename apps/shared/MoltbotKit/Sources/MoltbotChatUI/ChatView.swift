...
@MainActor
public struct KimibotChatView: View {
    public enum Style {
        case standard
        case onboarding
    }
    ...
    public init(
        viewModel: KimibotChatViewModel,
    ...
    private var visibleMessages: [KimibotChatMessage] {
        let base: [KimibotChatMessage]
    ...
    private func mergeToolResults(in messages: [KimibotChatMessage]) -> [KimibotChatMessage] {
    ...
    private func isToolResultMessage(_ message: KimibotChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: KimibotChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: KimibotChatMessage) -> String {
