...
public typealias KimibotPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias KimibotPlatformImage = UIImage
#endif

public struct KimibotChatUsageCost: Codable, Hashable, Sendable {
...
public struct KimibotChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: KimibotChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(KimibotChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct KimibotChatMessageContent: Codable, Hashable, Sendable {
...
public struct KimibotChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [KimibotChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: KimibotChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [KimibotChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: KimibotChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(KimibotChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([KimibotChatMessageContent].self, forKey: .content) {
...
public struct KimibotChatHistoryPayload: Codable, Sendable {
...
public struct KimibotSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct KimibotSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [KimibotSessionPreviewItem]
}

public struct KimibotSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [KimibotSessionPreviewEntry]

    public init(ts: Int, previews: [KimibotSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct KimibotChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct KimibotChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct KimibotAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct KimibotChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct KimibotGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct KimibotPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: KimibotPlatformImage?
...
public struct KimibotChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
