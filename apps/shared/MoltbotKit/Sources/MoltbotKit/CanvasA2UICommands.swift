...
public enum KimibotCanvasA2UICommand: String, Codable, Sendable {
...
public struct KimibotCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct KimibotCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
