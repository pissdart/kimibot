...
export function resolveTlonAccount(cfg: KimibotConfig, accountId?: string | null): TlonResolvedAccount {
...
export function listTlonAccountIds(cfg: KimibotConfig): string[] {
  const base = cfg.channels?.tlon as
