...
### Changes
- Version alignment with core Kimibot release numbers.
...
### Highlights
- First public release of the @kimibot/voice-call plugin.
...
- CLI: `kimibot voicecall` commands (call/start/continue/speak/end/status/tail/expose).
