...
Nostr DM channel plugin for Kimibot using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Kimibot. It enables your bot to:
...
```bash
kimibot plugins install @kimibot/nostr
```
...
# Configure kimibot to use local relay
