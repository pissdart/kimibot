...
export type MatrixMonitorHandlerParams = {
  ...
  core: {
    ...
    channel: typeof import("kimibot/plugin-sdk")["channel"];
    system: {
      enqueueSystemEvent: (
        text: string,
  ...
  mentionRegexes: ReturnType<
    typeof import("kimibot/plugin-sdk")["channel"]["mentions"]["buildMentionRegexes"]
  >;
              ...
              if (created) {
                ...
                try {
                  await sendMessageMatrix(
                    `room:${roomId}`,
                    [
                      "Kimibot: access not configured.",
                      "",
                      `Pairing code: ${code}`,
                      "",
                      "Ask the bot owner to approve with:",
                      "kimibot pairing approve matrix <code>",
                    ].join("\n"),
                    { client },
                  );
                } catch (err) {
