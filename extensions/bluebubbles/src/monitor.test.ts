...
import { removeAckReactionAfterReply, shouldAckReaction } from "kimibot/plugin-sdk";
import type { KimibotConfig, PluginRuntime } from "kimibot/plugin-sdk";
import {
...
function createMockRuntime(): PluginRuntime {
  return {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/kimibot") as unknown as PluginRuntime["state"]["resolveStateDir"],
    },
  };
}
