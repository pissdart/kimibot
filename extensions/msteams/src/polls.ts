...
export function extractMSTeamsPollVote(
  ...
  const pollId =
    readNestedString(value, ["kimibotPollId"]) ??
    readNestedString(value, ["pollId"]) ??
    readNestedString(value, ["kimibot", "pollId"]) ??
    readNestedString(value, ["kimibot", "poll", "id"]) ??
    readNestedString(value, ["data", "kimibotPollId"]) ??
    readNestedString(value, ["data", "pollId"]) ??
    readNestedString(value, ["data", "kimibot", "pollId"]);
    ...
    actions: [
      {
        ...
        title: "Vote",
        data: {
          kimibotPollId: pollId,
        },
        msteams: {
          type: "messageBack",
          text: "kimibot poll vote",
          displayText: "Vote recorded",
          value: { kimibotPollId: pollId },
        },
      },
    ],
  };
